    ...
    */
    ...
    var table = $('#individual-col-search').DataTable({
        ...
        "oLanguage": {
            ...
            "sInfo": "Страна _PAGE_ of _PAGES_",
...
"<'dt--bottom-section d-sm-flex justify-content-sm-between text-center'<'dt--pages-count  mb-sm-0 mb-3'i><'dt--pagination'p>>",
    ...
    */
    ...
    $('#html5-extension').DataTable({
        ...
        "columnDefs": [
            {
                "targets": [2],  // Index der Datums-Spalte (z.B. 2. Spalte für das Datum)
                "render": function (data, type, row) {
                    if (type === 'sort' || type === 'type') {
                        // Für die Sortierung das Datum im Format YYYY-MM-DD verwenden
                        return moment(data, "DD.MM.YYYY").format("YYYY-MM-DD");
                    }
                    // Für die Anzeige das Datum im Format DD.MM.YYYY anzeigen
